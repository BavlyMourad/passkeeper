...
class CategoryViewField extends StatelessWidget {
        ...
        children: categoryIds.map((id) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              color: Theme.of(context).colorScheme.activeChipBackground,
            ...
            child: Text(
              ...
              style: AppStyles.bodySmallSemiBold(
                context,
              ).copyWith(color: Theme.of(context).colorScheme.activeChipText),
            ),
          );
        }).toList(),
      ),
